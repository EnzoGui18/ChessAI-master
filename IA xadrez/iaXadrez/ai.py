...
class Heuristics:
    ...
    # As tabelas indicam os pontos marcados pela posição das peças de xadrez no tabuleiro.
    ...
    # Retorna a pontuação da posição de determinado tipo de peça.
    # Um tipo de peça pode ser, por exemplo: pieces.Pawn.PIECE_TYPE.
    # A tabela é a matriz numpy 2d usada para a pontuação. Exemplo:s Heuristics.PAWN_TABLE
    @staticmethod
