...
class Board:
    ...
    def perform_move(self, move):
        ...
        # se um peão chega ao fim, atualize-o para uma rainha.
    ...
    # Retorna se a cor fornecida estiver marcada.
    ...
    # Retorna a peça em determinada posição ou 0 se: Nenhuma peça ou fora dos limites.
